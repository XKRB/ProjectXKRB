...
public class LoginController :  BaseController
{
    ...
    public LoginController(ILogInService loginService, IConfiguration config, IStringLocalizer<BaseController> localizer) : base(localizer)
    {
    ...
    //    var user = UserConstants.Users.FirstOrDefault(user => user.UserName.ToLower() == userLogin.UserName.ToLower() && user.UserPassword == userLogin.UserPassword);
    //    if (user != null)
    //    {
    //        return user;
    //    }
